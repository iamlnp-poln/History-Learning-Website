  ...
  return (
    <div className="fixed inset-0 z-[5000] bg-slate-950 font-sans text-slate-200 flex flex-col items-center">
      ...
      <header className="relative z-20 text-center pt-8 pb-6 w-full bg-slate-900 border-b border-slate-700 shadow-xl shrink-0">
        <button onClick={() => setShowExitConfirm(true)} className="absolute top-1/2 left-4 md:left-8 -translate-y-1/2 p-2 bg-slate-800 rounded-full hover:bg-slate-700 transition-colors text-cyan-400 border border-cyan-500/30 z-50" title="Quay lại"><ArrowLeft size={24} /></button>
      ...
      <ConfirmationModal 
        ...
        message="Dữ liệu tình báo chưa được lưu. Bạn có chắc muốn thoát?"
        confirmLabel="Rút lui"
